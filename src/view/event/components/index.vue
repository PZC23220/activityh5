    ...
    <swiper :options="swiperOption" ref="mySwiper" class="event-content">
        <swiper-slide id="swiper1" class="event-live">
          ...
          <div class="index-content">
            <img :src="'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/Groupywebsite/img_guangzhou.png'" class="index-address"><br>
        ...
        <swiper-slide id="swiper2" class="event-live">
          <div class="event-bg-content"><img :src="'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/Groupywebsite/bg_ffacg.jpg'" class="event-bg"><span class="vertical-align"></span></div>
          ...
          <div class="ffacg-content-auto" id="scroll1">
            <div class="index-content ffacg-content">
              ...
              <a href="https://www.fireflyacg.com/" target="_blank" class="hp-links"><span>イベントHP：<em>https://www.fireflyacg.com/</em></span><span class="index-activity-goto ffacg-goto"></span></a><br>
        ...
        <swiper-slide id="swiper3" class="event-live">
          <div class="event-bg-content"><img :src="'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/Groupywebsite/bg_live.jpg'" class="event-bg"><span class="vertical-align"></span></div>
