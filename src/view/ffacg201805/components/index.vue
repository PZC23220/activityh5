<template>
    <div class="main">
         <div class="content">
            <img v-if="isOver" src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-ffacg201805-over.jpg" class="banner">
            <img v-else src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-ffacg201805.jpg" class="banner">
        ...
        data() {
            return {
                ...
                activity: {
                    ...
                    desc: {
                        title: 'FFACGとは？',
                        p1: 'FFACGとは、来場者数20万人超えの中国最大級のアニメゲームイベントFirefly ACG Festival（蛍火虫動漫遊戯嘉年華）です（公式HP：https://www.fireflyacg.com）。',
            ...
            shareSns(val) {
                ...
                if(self.isFans) {
                    if(location.hostname == 'activity.groupy.vip') {
                        var shareURL = `https://share.groupy.vip/html/activity_ffacg201805/index.html?activityId=${getParams('activityId')}&idolId=${self.me.idol_id}`;
                    }else {
                        var shareURL = `https://share.groupy.cn/html/activity_ffacg201805/index.html?activityId=${getParams('activityId')}&idolId=${self.me.idol_id}`;
                    }
                    var title = `【#Groupy広告モデル1 】`;
                    var description = `上位1名は来場者数20万人超えの中国広州FFACG特大看板に掲載！応援してね(*≧∀≦*)~`;
                    var shareImg = `https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-ffacg201805.jpg`;
                }else {
                    if(location.hostname == 'activity.groupy.vip') {
                        var shareURL = `https://share.groupy.vip/html/activity_ffacg201805/index.html?activityId=${getParams('activityId')}&isFans=1`;
                    }else {
                        var shareURL = `https://share.groupy.cn/html/activity_ffacg201805/index.html?activityId=${getParams('activityId')}&isFans=1`;
                    }
                    var title = `【#Groupy広告モデル1 】`;
