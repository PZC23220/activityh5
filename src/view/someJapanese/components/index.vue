<template>
    <div class="main">
         <div class="content">
            <img v-if="isOver" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-someJapanese-over.png" class="banner">
            <img v-else src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/activity-someJapanese.png" class="banner">
          ...
          shareSns(val) {
            ...
            if(self.isFans) {
                if(location.hostname == 'activity.groupy.vip') {
                    var shareURL = `http://share.groupy.vip/html/activity_someJapanese/index.html?activityId=${getParams('activityId')}&idolId=${self.me.idol_id}`;
                }else {
                ...
                if(location.hostname == 'activity.groupy.vip') {
                    var shareURL = `http://share.groupy.vip/html/activity_someJapanese/index.html?activityId=${getParams('activityId')}&isFans=1`;
                }else {
