        ...
        methods: {
          shareSns(val) {
            ...
            if(self.isFans) {
                if(location.hostname == 'activity.groupy.vip') {
                    var shareURL = `https://share.groupy.vip/html/activity_books/index.html?activityId=${getParams('activityId')}&idolId=${self.me.idol_id}`;
                }else {
                    var shareURL = `https://share.groupy.cn/html/activity_books/index.html?activityId=${getParams('activityId')}&idolId=${self.me.idol_id}`;
                }
                ...
                if(location.hostname == 'activity.groupy.vip') {
                    var shareURL = `https://share.groupy.vip/html/activity_books/index.html?activityId=${getParams('activityId')}&isFans=1`;
                }else {
                    var shareURL = `https://share.groupy.cn/html/activity_books/index.html?activityId=${getParams('activityId')}&isFans=1`;
                }
                var title = `Groupy読書の秋動画コンテスト`;
          ...
          getList(token) {
            ...
            if(self.idx < 2) {
                ...
                http.get('https://activity.groupy.vip/japi/video/activityIdols',{
                    params: {
